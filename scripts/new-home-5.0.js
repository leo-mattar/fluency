document.addEventListener("DOMContentLoaded", function () {
  ...
  function marquee({
    ...
    sections.forEach(section => {
      const ticker = section.querySelector(tickerSelector);
  ...
  function init() {
    ...
    // marquee();
    marquee({
      containerSelector: ".c-section.hm-partner",
      tickerSelector: ".c-marquee",
      listSelector: ".c-marquee-list",
    });

    marquee({
      containerSelector: ".c-section.hm-hero",
      tickerSelector: ".c-hero-m",
      listSelector: ".c-hero-m-list",
    });
  }
